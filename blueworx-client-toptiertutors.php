...
define( 'BLUEWORX_TOPTIERTUTORS_VERSION', '0.3.1' );
 ...
 * bluegroup_core_foundation â€” the library is vendored at plugin-update-checker/
 ...
 *
 * in wp-config.php â€” never in the plugin, never in the repo. Guarded so the same
...
/*
 * Install the zip attached to the Release, not GitHub's source tarball â€” the
